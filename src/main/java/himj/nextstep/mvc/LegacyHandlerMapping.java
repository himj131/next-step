...
import himj.nextstep.controller.ForwardController;
import himj.nextstep.controller.HomeController;
import himj.nextstep.controller.qna.*;
import himj.nextstep.controller.user.*;
import himj.nextstep.nmvc.HandlerMapping;
import himj.nextstep.webserver.DispatcherServlet;
...
public class LegacyHandlerMapping implements HandlerMapping {
    ...
    void initMapping(){
        ...
        mappings.put("/qna/deleteQuestion", new DeleteQuestionJspController());
        mappings.put("/api/qna/deleteQuestion", new DeleteQuestionJsonController());
